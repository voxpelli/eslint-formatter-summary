...
- **Lint enforcement for `@see` / `{@link}` convention** (2026-04-21) — Project
  convention (see AGENTS.md and BM `engineering/tooling/jsdoc-see-and-link-proper-usage`)
  ...
  Ownership: upstream · Workaround: full — project convention documented in AGENTS.md and applied by hand
