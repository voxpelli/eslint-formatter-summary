...
// Mirrors `CliCommandRun`'s signature with a Promise-only return — an async
// function can't be annotated with the `Promise<void> | void` union (TS1065).
/** @type {(argv: string[], meta: CliMeta, context: { parentName: string }) => Promise<void>} */
