 ...
 * @see {@link constructFootnote} — formatter markdown consumer; renders as blockquote lines.
 * @see {@link renderFootnote} — CLI consumer; renders as `<sub><em>` legend and filters out `(invalid rule id)`.
