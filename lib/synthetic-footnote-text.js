 ...
 * @see format-results.js `constructFootnote` — formatter markdown consumer; renders as blockquote lines.
 * @see lib/cli/render-footnote.js `renderFootnote` — CLI consumer; renders as `<sub><em>` legend and filters out `(invalid rule id)`.
