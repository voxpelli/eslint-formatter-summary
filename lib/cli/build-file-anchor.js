 ...
 * `<sub>` tag.
 *
 * @see {@link ../format-results.js|renderFileEntry (formatter twin, path-only, no line anchor)}
 * @see {@link ../sanitize-untrusted.js|sanitize — applied to untrusted path+detail}
 * @param {string} entry
 * @param {string} slug
 * @returns {string}
 */
