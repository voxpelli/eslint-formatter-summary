...
/**
 * Strip control chars, scrub secret-shaped substrings, then cap length.
 ...
 *
 * @see {@link ./escape-html.js|escapeHtml — always composed after sanitize}
 * @see {@link ./strip-controls.js|stripControls — bidi/zero-width codepoint removal}
